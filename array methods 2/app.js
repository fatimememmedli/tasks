...
//   elem.name.toLowerCase().trim().includes(a.toLowerCase().trim())
// );
// console.log(result);

// task-3

// let result = products.filter((elem) => elem.discontinued == true);
// console.log(result);

// task-4
// let result = products.filter((elem) => elem.unitPrice > 22);
// console.log(result);
...
let result = arr.every((elem) => elem.isDiscounted == true);
console.log(result);

let result2 = arr.some((elem) => elem.isDiscounted == true);
console.log(result2);
